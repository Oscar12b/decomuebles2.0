...
export const ParteCotizacion = () => {
  return (
    <div className="contenedor">
      ...
      <div className="foto2" style={{ width: "35%", borderRadius: "2.8rem", boxShadow : "5px 5px 10px rgba(0, 0, 0, 0.3)" }}>
        <img className="imagenes" src="/bsnner2cotizacion.png" alt="Banner 2" />
      </div>
      <div className="fototexto" style={{ width: "25%" }}>
        <img className="imagentext" style = {{borderRadius : "0.4 rem"}} src="/cotiza_banner1.jpg" alt="Banner 3" />
