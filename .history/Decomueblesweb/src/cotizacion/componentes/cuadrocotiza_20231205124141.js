...
import Stepper from '@mui/material/Stepper'; // Fixed import path
import Step, { stepClasses } from '@mui/material/Step'; // Fixed import path
import StepIndicator, { stepIndicatorClasses } from '@mui/material/StepIndicator'; // Fixed import path
import Typography from '@mui/material/Typography'; // Fixed import path
