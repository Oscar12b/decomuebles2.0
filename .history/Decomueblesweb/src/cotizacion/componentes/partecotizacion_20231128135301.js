  ...
  return (
    <div className="about-us">
      <div className="div">
        ...
        <img className="image" alt="Image" src="/public/cotiza_banner1.jpg" />
        <img className="img" alt="Image" src="image-79.png" />
        <img className="rectangle" alt="Rectangle" src="rectangle-47.png" />
